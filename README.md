...
![Версия](https://img.shields.io/badge/Версия-0.3.8.22-1F6FEB) ![.NET](https://img.shields.io/badge/.NET-10-512BD4) ![Windows/WPF](https://img.shields.io/badge/Windows-WPF-4B8BBE) ![Linux/Avalonia](https://img.shields.io/badge/Linux-Avalonia%2011-8B5CF6) ![Лицензия](https://img.shields.io/badge/Лицензия-Open%20Source-success)
...
- **Проверка обновлений конфигураций 1С (F9)** — проверка для выбранной ИБ по web-ресурсу обновлений 1С, подсветка нового релиза и загрузка дистрибутива.
