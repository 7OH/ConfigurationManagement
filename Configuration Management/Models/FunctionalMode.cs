...
/// <item><see cref="Specialist"/> («Специалист») — полный набор операций со списком баз,
/// но без разработческих инструментов.</item>
/// <item><see cref="Developer"/> («Разработчик») — все возможности, включая разработческие
/// инструменты конфигуратора.</item>
/// </list>
...
{
    /// <summary>«Пользователь»: ограниченный набор возможностей.</summary>
    User,

    /// <summary>«Специалист»: полный набор операций со списком баз.</summary>
    Specialist,

    /// <summary>«Разработчик»: все возможности, включая инструменты конфигуратора.</summary>
    Developer
}
